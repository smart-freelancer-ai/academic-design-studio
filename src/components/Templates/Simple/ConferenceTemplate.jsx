        ...
        <div className="bg-white/5 backdrop-blur p-8 rounded-2xl">
          ...
          <ul className="space-y-5 text-gray-100">
            <li className="flex items-start gap-3">
              ...
              <span className="flex-1">إدارة الصف وتكنولوجيا التعليم</span>
            </li>
            <li className="flex items-start gap-3">
              <i className="fas fa-chalkboard-teacher text-[#ffd700] text-lg mt-1" />
              <span className="flex-1">التربية الخاصة وصعوبات التعلم</span>
            </li>
            <li className="flex items-start gap-3">
              <i className="fas fa-graduation-cap text-[#ffd700] text-lg mt-1" />
              <span className="flex-1">الاتجاهات العالمية في بناء المناهج</span>
            </li>
            <li className="flex items-start gap-3">
              <i className="fas fa-laptop text-[#ffd700] text-lg mt-1" />
              <span className="flex-1">استراتيجيات التعليم الرقمي</span>
            </li>
            <li className="flex items-start gap-3">
              <i className="fas fa-robot text-[#ffd700] text-lg mt-1" />
              <span className="flex-1">استخدامات الذكاء الاصطناعي في التعليم</span>
            </li>
          </ul>
        </div>
