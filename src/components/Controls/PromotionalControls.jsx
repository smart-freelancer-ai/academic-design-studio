    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-3 gap-2">
        <div>
          ...
          <input
            type="text"
            value={designData.originalPrice || ''}
            onChange={(e) => updateDesignData({ originalPrice: e.target.value })}
        ...
        <div>
          ...
          <input
            type="text"
            value={designData.discountPrice || ''}
            onChange={(e) => updateDesignData({ discountPrice: e.target.value })}
            className="w-full px-3 py-2 text-sm border-2 border-gray-200 rounded-lg focus:border-academic-purple focus:ring-2 focus:ring-academic-purple/20 transition-all"
          />
        </div>
        ...
        <div>
          ...
          <input
            type="text"
            value={designData.discount || ''}
            onChange={(e) => updateDesignData({ discount: e.target.value })}
            placeholder="34%"
            className="w-full px-3 py-2 text-sm border-2 border-gray-200 rounded-lg focus:border-academic-purple focus:ring-2 focus:ring-academic-purple/20 transition-all"
          />
        </div>
...
export default PromotionalControls
